...
var radius = (document.getElementById('whiteboard-canvas-container').clientWidth + document
		.getElementById('whiteboard-canvas-container').clientHeight) / 150;
var dragging = false;
...
var putPoint = function(e) {
	...
	if (dragging) {
		...
		context.stroke();
		context.beginPath();
		context.arc(getMousePosition(e).x, getMousePosition(e).y, radius, 0,
				Math.PI * 2);
		context.fill();
		context.beginPath();
